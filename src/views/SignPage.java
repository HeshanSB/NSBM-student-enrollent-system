...
public class SignPage extends javax.swing.JFrame {
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
        ...
        bstu = new BachelorStudent(fullName,nameWithInitials,stuId,addressNo,addressRd,addressCity,dob,email,password,year);
       if(stuId!=0 && year!=0){
        try{
            int res1 = BachelorStudentController.addStudent(bstu);
        ...
        try{
            int res2 = BachelorStudentController.addStudentAddress(bstu);
            if (res2> 0) {
