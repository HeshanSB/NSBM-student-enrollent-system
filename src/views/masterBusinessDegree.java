 ...
 * @author Heshan
 */
public class masterBusinessDegree extends javax.swing.JFrame {

    /**
     * Creates new form masterBusinessDegree
     */
    public masterBusinessDegree() {
        initComponents();
        setSize(710,550);
    }
    ...
    private void fristSemBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fristSemBtnActionPerformed
        try{
            ...
            Logger.getLogger(masterBusinessDegree.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(masterBusinessDegree.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(masterBusinessDegree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
