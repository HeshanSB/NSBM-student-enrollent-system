 ...
 * @author Heshan
 */
public class masterComputingDegree extends javax.swing.JFrame {

    /**
     * Creates new form masterComputingDegree
     */
    public masterComputingDegree() {
        initComponents();
        setSize(710,550);
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(fristSemBtn);
        fristSemBtn.setBounds(540, 90, 60, 23);
        ...
        jPanel3.add(secondSemBtn);
        secondSemBtn.setBounds(540, 90, 60, 23);
    ...
    private void fristSemBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fristSemBtnActionPerformed
        try{
            ...
            Logger.getLogger(masterComputingDegree.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(masterComputingDegree.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(masterComputingDegree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
